...
function CSAppContent() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#F4F4F5] flex flex-col items-center justify-start antialiased relative font-sans select-none">
      ...
      <div className="w-full max-w-md md:max-w-3xl lg:max-w-5xl xl:max-w-6xl portrait:max-w-none portrait:border-x-0 md:border-x md:border-[#1F1F22] min-h-screen bg-[#050505] flex flex-col relative pb-36">
        ...
        <nav 
          ...
          translate="no" 
          className="fixed bottom-0 left-0 right-0 bg-black/40 backdrop-blur-xl border-t border-white/5 z-40 px-2 py-2 flex items-center justify-around notranslate h-[56px] max-w-md md:max-w-3xl lg:max-w-5xl xl:max-w-6xl portrait:max-w-none mx-auto"
        >
